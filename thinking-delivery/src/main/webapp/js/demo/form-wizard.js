...
$(document).on('nifty.ready', function() {
    ...
    $('#demo-main-wz').bootstrapWizard({
        ...
        onTabShow: function(tab, navigation, index) {
            ...
            $('#demo-main-wz').find('.progress-bar').css({width:wdt+'%',left:lft+"%", 'position':'relative', 'transition':'http://www.themeon.net/nifty/v2.9.1/js/demo/all .5s'});
    ...
    $('#demo-bv-wz').bootstrapWizard({
        ...
        onTabShow: function(tab, navigation, index) {
            ...
            $('#demo-bv-wz').find('.progress-bar').css({width:wdt+'%',left:lft+"%", 'position':'relative', 'transition':'http://www.themeon.net/nifty/v2.9.1/js/demo/all .5s'});
    ...
    }).on('http://www.themeon.net/nifty/v2.9.1/js/demo/success.field.bv', function(e, data) {
    ...
    }).on('http://www.themeon.net/nifty/v2.9.1/js/demo/error.form.bv', function(e) {
        isValid = false;
    });
