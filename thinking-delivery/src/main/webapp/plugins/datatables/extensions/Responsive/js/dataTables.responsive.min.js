...
*/
(function(c){"function"===typeof define&&define.amd?define(["jquery","http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/datatables.net"],function(l){return c(l,window,document)}):"object"===typeof exports?module.exports=function(l,k){l||(l=window);if(!k||!k.fn.dataTable)k=require("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/datatables.net")(l,k).$;return c(k,l,l.document)}:c(jQuery,window,document)})(function(c,l,k,p){var m=c.fn.dataTable,j=function(b,a){if(!m.versionCheck||!m.versionCheck("1.10.3"))throw"DataTables Responsive requires DataTables 1.10.3 or newer";this.s={dt:new m.Api(b),columns:[],
current:[]};this.s.dt.settings()[0].responsive||(a&&"string"===typeof a.details?a.details={type:a.details}:a&&!1===a.details?a.details={type:!1}:a&&!0===a.details&&(a.details={type:"inline"}),this.c=c.extend(!0,{},j.defaults,m.defaults.responsive,a),b.responsive=this,this._constructor())};c.extend(j.prototype,{_constructor:function(){var b=this,a=this.s.dt,d=a.settings()[0],e=c(l).width();a.settings()[0]._responsive=this;c(l).on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/resize.dtr orientationchange.dtr",m.util.throttle(function(){var a=
c(l).width();a!==e&&(b._resize(),e=a)}));d.oApi._fnCallbackReg(d,"aoRowCreatedCallback",function(e){-1!==c.inArray(!1,b.s.current)&&c(">td, >th",e).each(function(e){e=a.column.index("toData",e);!1===b.s.current[e]&&c(this).css("display","none")})});a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/destroy.dtr",function(){a.off(".dtr");c(a.table().body()).off(".dtr");c(l).off("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/resize.dtr orientationchange.dtr");c.each(b.s.current,function(a,e){!1===e&&b._setColumnVis(a,!0)})});this.c.breakpoints.sort(function(a,b){return a.width<b.width?1:a.width>
b.width?-1:0});this._classLogic();this._resizeAuto();d=this.c.details;!1!==d.type&&(b._detailsInit(),a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/column-visibility.dtr",function(){b._classLogic();b._resizeAuto();b._resize()}),a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/draw.dtr",function(){b._redrawChildren()}),c(a.table().node()).addClass("dtr-"+d.type));a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/column-reorder.dtr",function(){b._classLogic();b._resizeAuto();b._resize()});a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/column-sizing.dtr",function(){b._resizeAuto();b._resize()});a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/preXhr.dtr",function(){var e=[];a.rows().every(function(){this.child.isShown()&&
e.push(this.id(true))});a.one("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/draw.dtr",function(){a.rows(e).every(function(){b._detailsDisplay(this,false)})})});a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/init.dtr",function(){b._resizeAuto();b._resize();c.inArray(false,b.s.current)&&a.columns.adjust()});this._resize()},_columnsVisiblity:function(b){var a=this.s.dt,d=this.s.columns,e,f,g=d.map(function(a,b){return{columnIdx:b,priority:a.priority}}).sort(function(a,b){return a.priority!==b.priority?a.priority-b.priority:a.columnIdx-b.columnIdx}),h=c.map(d,function(a){return a.auto&&
...
(!0===g||!1===g)&&c(e.table().node()).triggerHandler("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/responsive-display.dt",[e,b,g,a])}},_detailsInit:function(){var b=this,a=this.s.dt,d=this.c.details;"inline"===d.type&&(d.target="td:first-child, th:first-child");a.on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/draw.dtr",function(){b._tabIndexes()});b._tabIndexes();c(a.table().body()).on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/keyup.dtr","td, th",function(b){b.keyCode===13&&c(this).data("dtr-keyboard")&&c(this).click()});var e=d.target;c(a.table().body()).on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/click.dtr mousedown.dtr mouseup.dtr","string"===typeof e?e:"td, th",
...
b.child.isShown()||!b.responsive.hasHidden())return b.child(!1),c(b.node()).removeClass("parent"),!1;b.child(d(),"child").show();c(b.node()).addClass("parent");return!0},modal:function(b){return function(a,d,e){if(d)c("div.dtr-modal-content").empty().append(e());else{var f=function(){g.remove();c(k).off("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/keypress.dtr")},g=c('<div class="dtr-modal"/>').append(c('<div class="dtr-modal-display"/>').append(c('<div class="dtr-modal-content"/>').append(e())).append(c('<div class="dtr-modal-close">&times;</div>').click(function(){f()}))).append(c('<div class="dtr-modal-background"/>').click(function(){f()})).appendTo("body");
c(k).on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/keyup.dtr",function(a){27===a.keyCode&&(a.stopPropagation(),f())})}b&&b.header&&c("div.dtr-modal-content").prepend("<h2>"+b.header(a)+"</h2>")}}};j.renderer={listHidden:function(){return function(b,a,d){return(b=c.map(d,function(a){return a.hidden?'<li data-dtr-index="'+a.columnIndex+'" data-dt-row="'+a.rowIndex+'" data-dt-column="'+a.columnIndex+'"><span class="dtr-title">'+a.title+'</span> <span class="dtr-data">'+a.data+"</span></li>":""}).join(""))?c('<ul data-dtr-index="'+a+'" class="dtr-details"/>').append(b):
...
this.context[0];return b._responsive?-1!==c.inArray(!1,b._responsive.s.current):!1});j.version="2.1.1";c.fn.dataTable.Responsive=j;c.fn.DataTable.Responsive=j;c(k).on("http://www.themeon.net/nifty/v2.9.1/plugins/datatables/extensions/Responsive/js/preInit.dt.dtr",function(b,a){if("dt"===b.namespace&&(c(a.nTable).hasClass("responsive")||c(a.nTable).hasClass("dt-responsive")||a.oInit.responsive||m.defaults.responsive)){var d=a.oInit.responsive;!1!==d&&new j(a,c.isPlainObject(d)?d:{})}});return j});
