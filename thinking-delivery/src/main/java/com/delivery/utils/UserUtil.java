...
public class UserUtil {
     ...
     * @return
     */
    public static String randomChineseNickName(boolean simple, int len) {
        String surName[] = {
	...
	public static void main(String[] args) {
		String randomAccount = getStringRandom(20);
		System.out.println("randomAccount:" + randomAccount);
	}
}
